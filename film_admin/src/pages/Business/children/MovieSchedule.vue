...
<script>
    import {getCurrentPageBMovieSchedule,getOptions2,getHallByCinemaId,addScheduleInfo,deleteMovieSchedule} from '../../../api/index'
    ...
    export default {
        ...
        methods: {
          ...
          async addSchedule(){
            this.scheduleInfo = {};
            this.scheduleInfo.cinemaId = this.$cookies.get("cinemaId");
          ...
          async getHall(){
            this.hallOptions = [];
            let json = await getHallByCinemaId(this.$cookies.get("cinemaId"));
            if (json.state===200){
