...
<script>
    ...
    import {getCurrentPageBHall,deleteHall,updateHallInfo,addHall,getOptions,getSeats,commitSeat} from "../../../api";
    import Vue from "vue"
    export default {
        name: "HallManage",
        data(){
        ...
        methods:{
          ...
          handleEdit(index, row) {
            ...
            this.hallInfo = row;
            this.hallInfo.cinemaId = this.$cookies.get("cinemaId");
          ...
          async commitAddHall(){
              let json = await addHall(this.$cookies.get("cinemaId"),this.addHallTypeId);
              if (json.state===200) {
